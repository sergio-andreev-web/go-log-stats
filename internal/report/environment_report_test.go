...
func TestEnvironmentReport(t *testing.T) {
	...
	report.Add(Event{Environment: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Environment: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Environment: "beta", DurationMS: 5})
