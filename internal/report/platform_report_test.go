...
func TestPlatformReport(t *testing.T) {
	report := NewPlatformReport()
	report.Add(Event{Platform: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Platform: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Platform: "beta", DurationMS: 5})
