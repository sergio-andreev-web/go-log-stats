...
func TestQueueReport(t *testing.T) {
	report := NewQueueReport()
	report.Add(Event{Queue: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Queue: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Queue: "beta", DurationMS: 5})
