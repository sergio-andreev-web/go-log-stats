...
func TestTraceReport(t *testing.T) {
	report := NewTraceReport()
	report.Add(Event{Trace: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Trace: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Trace: "beta", DurationMS: 5})
