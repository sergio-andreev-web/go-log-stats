...
func TestVersionReport(t *testing.T) {
	report := NewVersionReport()
	report.Add(Event{Version: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Version: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Version: "beta", DurationMS: 5})
