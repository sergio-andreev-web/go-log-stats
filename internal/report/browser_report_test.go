...
func TestBrowserReport(t *testing.T) {
	report := NewBrowserReport()
	report.Add(Event{Browser: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Browser: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Browser: "beta", DurationMS: 5})
