...
func TestHostReport(t *testing.T) {
	report := NewHostReport()
	report.Add(Event{Host: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Host: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Host: "beta", DurationMS: 5})
