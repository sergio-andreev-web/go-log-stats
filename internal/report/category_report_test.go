...
func TestCategoryReport(t *testing.T) {
	report := NewCategoryReport()
	report.Add(Event{Category: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Category: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Category: "beta", DurationMS: 5})
