...
func TestRegionReport(t *testing.T) {
	report := NewRegionReport()
	report.Add(Event{Region: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Region: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Region: "beta", DurationMS: 5})
