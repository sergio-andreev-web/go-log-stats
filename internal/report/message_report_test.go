...
func TestMessageReport(t *testing.T) {
	report := NewMessageReport()
	report.Add(Event{Message: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Message: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Message: "beta", DurationMS: 5})
