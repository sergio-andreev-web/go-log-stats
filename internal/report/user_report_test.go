...
func TestUserReport(t *testing.T) {
	...
	report.Add(Event{User: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{User: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{User: "beta", DurationMS: 5})
