...
func TestPathReport(t *testing.T) {
	report := NewPathReport()
	report.Add(Event{Path: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Path: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Path: "beta", DurationMS: 5})
