...
func TestOutcomeReport(t *testing.T) {
	report := NewOutcomeReport()
	report.Add(Event{Outcome: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Outcome: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Outcome: "beta", DurationMS: 5})
