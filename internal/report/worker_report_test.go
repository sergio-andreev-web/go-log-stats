...
func TestWorkerReport(t *testing.T) {
	...
	report.Add(Event{Worker: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Worker: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Worker: "beta", DurationMS: 5})
