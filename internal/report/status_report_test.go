...
func TestStatusReport(t *testing.T) {
	...
	report.Add(Event{Status: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Status: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Status: "beta", DurationMS: 5})
