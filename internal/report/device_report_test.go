...
func TestDeviceReport(t *testing.T) {
	report := NewDeviceReport()
	report.Add(Event{Device: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Device: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Device: "beta", DurationMS: 5})
