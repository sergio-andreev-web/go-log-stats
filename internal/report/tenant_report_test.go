...
func TestTenantReport(t *testing.T) {
	report := NewTenantReport()
	report.Add(Event{Tenant: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Tenant: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Tenant: "beta", DurationMS: 5})
