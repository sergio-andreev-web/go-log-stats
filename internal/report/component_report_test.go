...
func TestComponentReport(t *testing.T) {
	...
	report.Add(Event{Component: "alpha", Level: "error", DurationMS: 10, Bytes: 100})
	report.Add(Event{Component: "alpha", DurationMS: 20, Bytes: 50})
	report.Add(Event{Component: "beta", DurationMS: 5})
